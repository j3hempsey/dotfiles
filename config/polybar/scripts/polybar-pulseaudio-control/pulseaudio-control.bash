...
MUTED_COLOR="%{F#B21818}"  # Color when the audio is muted
...
SINK_BLACKLIST=(
	...
	"alsa_output.pci-0000_2e_00.1.hdmi-stereo-extra2" # HDMI monitor output
)
...
declare -A SINK_NICKNAMES=(
	...
	["alsa_output.pci-0000_31_00.3.analog-stereo"]="Speakers"
	["alsa_output.usb-SteelSeries_SteelSeries_Arctis_5_00000000-00.iec958-stereo"]="SteelSeries"
)
